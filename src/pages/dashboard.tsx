...
export default function Dashboard() {
  ...
  const [userBalance, setUserBalance] = useState(6697.20); // Mock balance after portfolio allocation
  const [portfolioValue, setPortfolioValue] = useState(4652.80); // Mock portfolio value
  const [totalValue, setTotalValue] = useState(11350.00); // Mock total value (balance + portfolio)
                  ...
                  <div className="space-y-6">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          <p>
                            The market is currently showing <strong>moderate bullish trends</strong> with technology and healthcare sectors outperforming. 
                          ...
                          <p>
                            ...
                            and 40% to value stocks. Consider increasing exposure to AI, cloud computing, and renewable energy sectors.
                          </p>
                          <div className="bg-muted/50 p-4 rounded-lg border border-border">
                            ...
                            <ul className="space-y-2">
                              <li className="flex items-center gap-2">
                                ...
                                <span>S&P 500 showing positive momentum with 2.3% gain over past month</span>
                              </li>
                              <li className="flex items-center gap-2">
                                <Check className="h-4 w-4 text-green-500" />
                                <span>Tech sector leading with 4.1% growth, driven by AI and cloud services</span>
                              </li>
                              <li className="flex items-center gap-2">
                              ...
                              <li className="flex items-center gap-2">
                                <Check className="h-4 w-4 text-green-500" />
                                <span>Federal Reserve signaling stable interest rates for next quarter</span>
                              </li>
                            </ul>
                          </div>
                        </div>
